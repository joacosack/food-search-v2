export const CATALOG = [
  ...
  {
    "id": "exp101",
    "dish_name": "Risotto de hongos trufado",
    "description": "Risotto cremoso con hongos de estación, perfume de trufa y parmesano envejecido.",
    "categories": [
      "pasta"
    ],
    "synonyms": [
  ...
  {
    "id": "exp102",
    "dish_name": "Lomo grill con papines glaseados",
    "description": "Filet de lomo grillado en manteca de hierbas, papines andinos y reducción de malbec.",
    "categories": [
      "parrilla"
    ],
    "synonyms": [
  ...
  {
    "id": "exp201",
    "dish_name": "Combo ahorro de empanadas",
    "description": "Seis empanadas a elección con bebida incluida, ideal para fin de mes.",
    "categories": [
      "combos",
      "empanadas"
    ],
  ...
  {
    "id": "exp202",
    "dish_name": "Bowl económico de fideos salteados",
    "description": "Fideos salteados con vegetales de estación, salsa de soja ligera y mix de semillas.",
    "categories": [
      "wok",
      "bowls"
    ],
  ...
  {
    "id": "exp301",
    "dish_name": "Wrap express de pollo grillado",
    "description": "Wrap de pollo grillado con mix de verdes, alioli suave y chips de batata.",
    "categories": [
      "sandwich"
    ],
    "synonyms": [
  ...
  {
    "id": "exp302",
    "dish_name": "Ensalada vital express",
    "description": "Mix de hojas verdes, quinoa, garbanzos asados y aderezo cítrico listo para llevar.",
    "categories": [
      "ensalada"
    ],
    "synonyms": [
  ...
  {
    "id": "exp303",
    "dish_name": "Experiencia degustación Luz de Vela",
    "description": "Seis pasos creados por el chef con maridaje de espumante y velas aromáticas.",
    "categories": [
      "combos"
    ],
    "synonyms": [
  ...
  {
    "id": "exp304",
    "dish_name": "Combo ejecutivo veggie express",
    "description": "Wrap integral de falafel, ensalada fresca y limonada casera lista en minutos.",
    "categories": [
      "sandwich"
    ],
    "synonyms": [
  ...
  {
    "id": "exp305",
    "dish_name": "Cesta picnic gourmet para dos",
    "description": "Tabla de quesos artesanales, panes de masa madre, frutas frescas y limonada para compartir al aire libre.",
    "categories": [
      "combos"
    ],
    "synonyms": [
